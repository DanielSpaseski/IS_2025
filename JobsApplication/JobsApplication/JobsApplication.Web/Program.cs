...
using JobsApplication.Repository.Implementation;
...
builder.Services.AddDefaultIdentity<JobsApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
